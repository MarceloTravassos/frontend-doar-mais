...
export function Welcome() {
  return (
    <main className="bg-primary flex flex-col min-h-screen items-center px-6 text-white">
      ...
      <p className="mb-9 text-center font-bold text-xl">Escolha a opção corresponde ao seu caso</p>
      <div className="flex space-x-4 font-bold text-lg text-white">
        ...
        <button className="flex flex-col rounded-lg items-center leading-tight px-4 py-6 bg-secondary">
          <FontAwesomeIcon className="text-white w-10 h-10 mb-4" icon={faUser}/>
          <p className="w-28 uppercase">Ong</p>
        </button>
      </div>
    </main>
  );
